...
return [
	...
	'editor-color-palette' => [
		[
			'name'  => __( 'Custom color', 'immortals' ), // Called “Link Color” in the Customizer options. Renamed because “Link Color” implies it can only be used for links.
			'slug'  => 'theme-primary',
			'color' => $genesis_sample_link_color,
		],
		[
			'name'  => __( 'Accent color', 'immortals' ),
	...
	'editor-font-sizes'    => [
		[
			'name' => __( 'Small', 'immortals' ),
			'size' => 12,
			'slug' => 'small',
		],
		[
			'name' => __( 'Normal', 'immortals' ),
			'size' => 18,
			'slug' => 'normal',
		],
		[
			'name' => __( 'Large', 'immortals' ),
			'size' => 20,
			'slug' => 'large',
		],
		[
			'name' => __( 'Larger', 'immortals' ),
			'size' => 24,
			'slug' => 'larger',
		],
	],
